...
namespace VastGIS.Property.Helpers
{
    public class ZDSqlHelper
    {
        ...
        public const string DJZQ =
                "[YSDM] CHAR(10), [DJZQDM] CHAR(12), [DJZQMC] CHAR(100), [WX_DCY] CHAR(30), [WX_DCSJ] DATETIME, [WX_CLY] CHAR(30), [WX_CLSJ] DATETIME, [WX_ZTY] CHAR(30), [WX_ZTSJ] DATETIME, [WX_ZJY] CHAR(30), [WX_ZJSJ] DATETIME, [WX_WYDM] GUID NOT NULL"
            ;

        public const string ZDJBXX = "[YSDM] CHAR(10), [ZDDM] CHAR(19), [BDCDYH] CHAR(28), [ZDTZM] CHAR(2), [ZL] CHAR(200), [ZDMJ] FLOAT, [MJDW] CHAR(2), [YT] CHAR(4), [DJ] CHAR(2), [JG] FLOAT, [QLLX] CHAR(2), [QLXZ] CHAR(4), [QLSDFS] CHAR(2), [RJL] FLOAT, [JZMD] FLOAT, [JZXG] FLOAT, [ZDSZD] CHAR(200), [ZDSZN] CHAR(200), [ZDSZX] CHAR(200), [ZDSZB] CHAR(200), [ZDT] BLOB, [TFH] CHAR(50), [DJH] CHAR(20), [DAH] CHAR, [BZ] CHAR, [ZT] CHAR(2), [WX_DCY] CHAR(30), [WX_DCSJ] DATETIME, [WX_CLY] CHAR(30), [WX_CLSJ] DATETIME, [WX_ZTY] CHAR(30), [WX_ZTSJ] DATETIME, [WX_ZJY] CHAR(30), [WX_ZJSJ] DATETIME, [WX_WYDM] GUID NOT NULL";

        public const string JZD = "[ZDZHDM] CHAR, [YSDM] CHAR(10), [JZDH] CHAR(10), [SXH] INTEGER, [JBLX] CHAR(2), [JZDLX] CHAR(2), [XZBZ] FLOAT, [YZBZ] FLOAT, [WX_DCY] CHAR(30), [WX_DCSJ] DATETIME, [WX_CLY] CHAR(30), [WX_CLSJ] DATETIME, [WX_ZTY] CHAR(30), [WX_ZTSJ] DATETIME, [WX_ZJY] CHAR(30), [WX_ZJSJ] DATETIME, [WX_WYDM] GUID NOT NULL";

        public const string JZX =
                " [ZDZHDM] CHAR, [YSDM] CHAR(10), [JZXCD] FLOAT, [JZXLB] CHAR(2), [JZXWZ] CHAR(1), [JXXZ] CHAR(1), [QSJXXYSBH] CHAR(30), [QSJXXYS] BLOB, [QSZYYYSBH] CHAR(30), [QSZYYYS] BLOB, [WX_DCY] CHAR(30), [WX_DCSJ] DATETIME, [WX_CLY] CHAR(30), [WX_CLSJ] DATETIME, [WX_ZTY] CHAR(30), [WX_ZTSJ] DATETIME, [WX_ZJY] CHAR(30), [WX_ZJSJ] DATETIME, [WX_WYDM] GUID NOT NULL"
            ;

        public const string ZDTZJ = " [BDCDYH] CHAR(28), [YSDM] CHAR(10), [ZJNR] CHAR(200), [ZT] CHAR(50), [YS] CHAR(20), [BS] INTEGER, [XZ] CHAR(1), [XHX] CHAR(1), [KD] FLOAT, [GD] FLOAT, [ZJDZXJXZB] FLOAT, [ZJDZXJYZB] FLOAT, [ZJFX] FLOAT";
    }
}
