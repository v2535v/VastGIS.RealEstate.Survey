...
{
    public partial class Zdjbxxzj:INotifyPropertyChanging,INotifyPropertyChanged,IDatabaseFeature
    {
        #region 表结构
        Dictionary<string,bool> _isUnicodes=new Dictionary<string,bool>{{"Id",false},{"GLYSDM",false},{"YSDM",false},{"ZJNR",true},{"ZT",true},{"YS",false},{"BS",false},{"XZ",false},{"XHX",false},{"KD",false},{"GD",false},{"ZJDZXJXZB",false},{"ZJDZXJYZB",false},{"ZJFX",false},{"DatabaseId",false},{"FLAGS",false},{"XGR",false},{"XGSJ",false},{"geometry",false}};
        ...
        private const string SQL_DELETE_FLAG_ZDJBXXZJ = "UPDATE ZDJBXXZJ Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
