...
{
    public partial class TmpCadzj:INotifyPropertyChanging,INotifyPropertyChanged,IReFeature
    {
        #region 表结构
        ...
        #region 查询	
	    private const string SQL_INSERT_TMPCADZJ = "INSERT INTO TmpCadzj (EntityType, Handle, FileName, geometry) VALUES ( @EntityType, @Handle, @FileName, GeomFromText(@geometry,@SRID));" + " SELECT last_insert_rowid();";	
	    private const string SQL_UPDATE_TMPCADZJ = "UPDATE TmpCadzj SET EntityType = @EntityType, Handle = @Handle, FileName = @FileName, geometry = GeomFromText(@geometry,@SRID) WHERE Id = @Id";	
