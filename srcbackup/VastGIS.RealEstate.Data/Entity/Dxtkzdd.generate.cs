...
{
    public partial class Dxtkzdd:INotifyPropertyChanging,INotifyPropertyChanged,IBasemapPoint
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_DXTKZDD = "UPDATE DXTKZDD Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
