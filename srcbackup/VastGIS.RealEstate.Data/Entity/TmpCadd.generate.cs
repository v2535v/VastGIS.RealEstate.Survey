...
{
    public partial class TmpCadd:INotifyPropertyChanging,INotifyPropertyChanged,IReFeature
    {
        #region 表结构
        ...
        #region 查询	
	    private const string SQL_INSERT_TMPCADD = "INSERT INTO TmpCadd (EntityType, Handle, FileName, geometry) VALUES ( @EntityType, @Handle, @FileName, GeomFromText(@geometry,@SRID));" + " SELECT last_insert_rowid();";	
