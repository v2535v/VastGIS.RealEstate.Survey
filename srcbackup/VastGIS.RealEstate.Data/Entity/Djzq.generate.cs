...
{
    public partial class Djzq:INotifyPropertyChanging,INotifyPropertyChanged,IDatabaseFeature
    {
        #region 表结构
        Dictionary<string,bool> _isUnicodes=new Dictionary<string,bool>{{"Id",false},{"YSDM",false},{"DJZQDM",false},{"DJZQMC",true},{"WX_DCY",true},{"WX_DCSJ",false},{"WX_CLY",true},{"WX_CLSJ",false},{"WX_ZTY",true},{"WX_ZTSJ",false},{"WX_ZJY",true},{"WX_ZJSJ",false},{"WX_WYDM",false},{"DatabaseId",false},{"FLAGS",false},{"XGR",false},{"XGSJ",false},{"geometry",false}};
        ...
        private const string SQL_DELETE_FLAG_DJZQ = "UPDATE DJZQ Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
		...
		public bool Update(ISQLiteDao dao)
        {
            ...
            {							
				...
				command.Parameters.AddWithValue(PARAM_YSDM,this.Ysdm);
				command.Parameters.AddWithValue(PARAM_DJZQDM,this.Djzqdm);
				command.Parameters.AddWithValue(PARAM_DJZQMC,EncodingHelper.String2Unicode(this.Djzqmc));
