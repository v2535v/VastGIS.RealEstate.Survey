...
{
    public partial class Dxtzjx:INotifyPropertyChanging,INotifyPropertyChanged,IBasemapPolyline
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_DXTZJX = "UPDATE DXTZJX Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
