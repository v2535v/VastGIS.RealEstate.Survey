...
{
    public partial class Dxtqtm:INotifyPropertyChanging,INotifyPropertyChanged,IBasemapPolygon
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_DXTQTM = "UPDATE DXTQTM Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
