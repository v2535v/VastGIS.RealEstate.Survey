...
{
    public partial class Dxtkzdzj:INotifyPropertyChanging,INotifyPropertyChanged,IBasemapText
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_DXTKZDZJ = "UPDATE DXTKZDZJ Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
