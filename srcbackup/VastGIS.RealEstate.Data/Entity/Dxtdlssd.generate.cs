...
{
    public partial class Dxtdlssd:INotifyPropertyChanging,INotifyPropertyChanged,IBasemapPoint
    {
        #region 表结构
        Dictionary<string,bool> _isUnicodes=new Dictionary<string,bool>{{"Id",false},{"TC",true},{"CASSDM",false},{"FH",true},{"FHDX",false},{"XZJD",false},{"FSXX1",true},{"FSXX2",true},{"YSDM",false},{"DatabaseId",false},{"FLAGS",false},{"XGR",false},{"XGSJ",false},{"geometry",false}};
        ...
        private const string SQL_DELETE_FLAG_DXTDLSSD = "UPDATE DXTDLSSD Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
