...
{
    public partial class Dxtdlssm:INotifyPropertyChanging,INotifyPropertyChanged,IBasemapPolygon
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_DXTDLSSM = "UPDATE DXTDLSSM Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
