...
{
    public partial class Dxtsxssd:INotifyPropertyChanging,INotifyPropertyChanged,IBasemapPoint
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_DXTSXSSD = "UPDATE DXTSXSSD Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
