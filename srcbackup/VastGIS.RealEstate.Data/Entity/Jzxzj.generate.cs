...
{
    public partial class Jzxzj:INotifyPropertyChanging,INotifyPropertyChanged,IDatabaseFeature
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_JZXZJ = "UPDATE JZXZJ Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
