...
{
    public partial class Dxtjmdx:INotifyPropertyChanging,INotifyPropertyChanged,IBasemapPolyline
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_DXTJMDX = "UPDATE DXTJMDX Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
