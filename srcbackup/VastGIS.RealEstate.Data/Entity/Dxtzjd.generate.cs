...
{
    public partial class Dxtzjd:INotifyPropertyChanging,INotifyPropertyChanged,IBasemapPoint
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_DXTZJD = "UPDATE DXTZJD Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE  Id = @Id ";
        #endregion            
