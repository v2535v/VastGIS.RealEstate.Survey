...
namespace VastGIS.RealEstate.Data.Dao.Impl
{
    ...
    public partial class ZdDaoImpl
    {
        ...
        private string CREATE_JZX =
            ...
            "[WX_ZJSJ] DATETIME, [WX_WYDM] GUID, [QSJZDBH] CHAR(29),[JZJZDBH] CHAR(29),[DatabaseId] INTEGER DEFAULT 0,[FLAGS] SMALLINT DEFAULT 1,[XGR] VCHAR(10),[XGSJ] DATETIME);CREATE UNIQUE INDEX [ix_jzx_gzbh] ON[JZX] ([JZXGZBH]);"
            ;
        ...
        private string CREATE_JZD =
            ...
            "[WX_CLSJ] DATETIME, [WX_ZTY] NCHAR(30), [WX_ZTSJ] DATETIME, [WX_ZJY] NCHAR(30), [WX_ZJSJ] DATETIME, [WX_WYDM] GUID,[DatabaseId] INTEGER DEFAULT 0,[FLAGS] SMALLINT DEFAULT 1,[XGR] VCHAR(10),[XGSJ] DATETIME);" +
