    ...
    public partial class ucCoordinateList : UserControl
    {
        ...
        private void CheckVertexList()
        {
            ...
            else
            {
                ...
                _maxpart = _vertexs.Select(c => c.Part).Max()+1;
            }
        }
        ...
        private void DrawPoints()
        {
            PrepareLayer();
            DrawData();
            if (gridPoints.Table.SelectedRecords == null) return;
        ...
        /// <summary>
        /// The ucCoordinateList_Resize
        /// </summary>
        /// <param name="sender">The <see cref="object"/></param>
        /// <param name="e">The <see cref="EventArgs"/></param>
        private void ucCoordinateList_Resize(object sender, EventArgs e)
        {
            ...
            gridPoints.Height = this.Height - 111;
        }
