...
namespace VastGIS.Plugins.RealEstate.DataControls
{
    public partial class ucFeatureLists : UserControl
    {
        ...
        public void AddFeature(SearchFeature pFeature,List<VgObjectclass> classes)
        {
            if (_features == null)
            {
                _features=new BindingList<SearchFeature>();
        ...
        public void AddFeatures(List<SearchFeature> pFeatureList, List<VgObjectclass> classes)
        {
            if (_features == null)
            {
                _features = new BindingList<SearchFeature>();
        ...
        public void Redraw()
        {
            ...
            else
            {
                ...
                if (lstFeatures.SelectedIndex < 0) return;
                SearchFeature pSelectFeature = lstFeatures.SelectedItem as SearchFeature;
                DrawActiveFeature(pSelectFeature.Geometry);
            }
        ...
        public SearchFeature GetCurrentSelectedAndCheckedFeature()
        {
            ...
            return chkLstFeatures.SelectedItem as SearchFeature;
        }

        public List<IGeometry> GetSelectedGeometries()
        {
            List < IGeometry > geometries=new List<IGeometry>();
            foreach (SearchFeature item in chkLstFeatures.CheckedItems)
            {
