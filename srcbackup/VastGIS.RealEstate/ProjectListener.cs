...
namespace VastGIS.Plugins.RealEstate
{
    public class ProjectListener
    {
        ...
        private void RealEstateDatabase_EntityChanged(object sender, VastGIS.RealEstate.Data.Events.EntityChanedEventArgs e)
        {
            ...
            ILayer pLayer = _context.Map.Layers.FirstOrDefault(c => c.Name.ToUpper() == targetLayer);
            if (pLayer == null)
            {
                VgObjectclass oneclass=_classes.FirstOrDefault(c => c.Mc.ToUpper() == e.TableName.ToUpper());
                if (oneclass != null)
                {
