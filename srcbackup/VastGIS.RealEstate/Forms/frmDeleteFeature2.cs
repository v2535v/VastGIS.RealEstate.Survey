...
namespace VastGIS.Plugins.RealEstate.Forms
{
    public partial class frmDeleteFeature2:Form,IEditForm
    {
        ...
        public void SetQueryPoint(double dx, double dy)
        {
            ...
            List<SearchFeature> features = _database.SystemService.FindRecords(ucSelectLayer1.SelectedClasses, dx, dy);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            _database.SystemService.DeleteFeatures(ucFeatureLists1.GetSelectedFeatures());
            ucFeatureLists1.ClearList();
            ucFeatureLists1.ClearDrawing();
        }
    }
