...
{
    public partial class frmVGATTACHMENT:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgAttachment _linkedObject;
        ...
        {
            _linkedObject = _database.SystemService.GetVgAttachment(id);
            LinkObject();
        }
        ...
        {
            _database.SystemService.SaveVgAttachment(_linkedObject as VgAttachment);
        }
    }
