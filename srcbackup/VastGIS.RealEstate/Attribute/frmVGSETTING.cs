...
{
    public partial class frmVGSETTING:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgSetting _linkedObject;
        ...
        {
            _linkedObject = _database.SystemService.GetVgSetting(id);
            LinkObject();
        }
        ...
        {
            _database.SystemService.SaveVgSetting(_linkedObject as VgSetting);
        }
    }
