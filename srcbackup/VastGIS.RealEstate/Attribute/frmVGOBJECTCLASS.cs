...
{
    public partial class frmVGOBJECTCLASS:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgObjectclass _linkedObject;
        ...
        {
            _linkedObject = _database.SystemService.GetVgObjectclass(id);
            LinkObject();
        }
        ...
        {
            _database.SystemService.SaveVgObjectclass(_linkedObject as VgObjectclass);
        }
    }
