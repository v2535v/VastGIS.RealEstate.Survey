...
{
    public partial class frmVGCADCODE:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgCadcode _linkedObject;
        ...
        {
            _linkedObject = _database.SystemService.GetVgCadcode(id);
            LinkObject();
        }
        ...
        {
            _database.SystemService.SaveVgCadcode(_linkedObject as VgCadcode);
        }
    }
