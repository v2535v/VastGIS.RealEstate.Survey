...
{
    public partial class frmZDTOJZD:Form,IReAttributeForm
    {
        private string _objectKey;
        private Zdtojzd _linkedObject;
        ...
        {
            _linkedObject = _database.ZdService.GetZdtojzd(id);
            LinkObject();
        }
        ...
        {
            _database.ZdService.SaveZdtojzd(_linkedObject as Zdtojzd);
        }
    }
