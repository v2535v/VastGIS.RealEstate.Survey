...
{
    public partial class frmVGAREACODE:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgAreacode _linkedObject;
        ...
        {
            _linkedObject = _database.SystemService.GetVgAreacode(id);
            LinkObject();
        }
        ...
        {
            _database.SystemService.SaveVgAreacode(_linkedObject as VgAreacode);
        }
    }
