...
{
    public partial class frmTMPCADXDATA:Form,IReAttributeForm
    {
        private string _objectKey;
        private TmpCadxdata _linkedObject;
        ...
        {
            _linkedObject = _database.CadService.GetTmpCadxdata(id);
            LinkObject();
        }
        ...
        {
            _database.CadService.SaveTmpCadxdata(_linkedObject as TmpCadxdata);
        }
    }
