...
{
    public partial class frmVGCLASSDETAIL:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgClassdetail _linkedObject;
        ...
        {
            _linkedObject = _database.SystemService.GetVgClassdetail(id);
            LinkObject();
        }
        ...
        {
            _database.SystemService.SaveVgClassdetail(_linkedObject as VgClassdetail);
        }
    }
