...
{
    public partial class frmVGLAYERGROUP:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgLayergroup _linkedObject;
        ...
        {
            _linkedObject = _database.SystemService.GetVgLayergroup(id);
            LinkObject();
        }
        ...
        {
            _database.SystemService.SaveVgLayergroup(_linkedObject as VgLayergroup);
        }
    }
