...
namespace VastGIS.Plugins.RealEstate.Attribute
{
    public partial class frmBasemapText:Form,IReAttributeForm
    {
        ...
        private Dxtdldwzj _linkedObject;
        ...
        {
            InitializeComponent();
            _objectKey = "DXTDLDWZJ";
            _formName = "frmDXTDLDWZJ";
        ...
        {
            _linkedObject = _database.BasemapService.GetDxtdldwzj(id);
            LinkObject();
        }
        ...
        {
            _database.BasemapService.SaveDxtdldwzj(_linkedObject as Dxtdldwzj);
        }
    }
