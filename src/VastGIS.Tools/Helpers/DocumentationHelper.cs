// -------------------------------------------------------------------------------------------
// <copyright file="DocumentationHelper.cs" company="VastGIS RealEstate Team -- www.vastgis.com.cn">
...
namespace VastGIS.Tools.Helpers
{
    ...
    public static class DocumentationHelper
    {
        ...
        {
            return "http://www.mapwindow.org/Manuals/ToolBox/" + tool.GetType().Name + ".html?utm_source=VastGIS&utm_medium=cpc&utm_campaign=Manual";
        }
