...
namespace VastGIS.Plugins.Symbology.Views
{
    partial class RasterRenderingSubView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.colorSchemeCombo1 = new VastGIS.Plugins.Symbology.Controls.ImageCombo.ColorSchemeCombo();
            this.udBreakCount = new VastGIS.Plugins.Symbology.Controls.NumericUpDownEx(this.components);
            this.chkReverse = new CheckBox();
            this.rgbBandControl1 = new VastGIS.Plugins.Symbology.Controls.RgbBandControl();
            this.colorSchemeGrid = new VastGIS.Plugins.Symbology.Controls.RasterColorSchemeGrid();
            ...
            // colorSchemeCombo1
            // 
            this.colorSchemeCombo1.ComboStyle = VastGIS.Api.Enums.SchemeType.Graduated;
            ...
            this.colorSchemeCombo1.Target = VastGIS.Plugins.Symbology.SchemeTarget.Raster;
