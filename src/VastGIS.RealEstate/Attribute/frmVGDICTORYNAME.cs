...
{
    public partial class frmVgDictoryname:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgDictoryname _linkedObject;
        ...
        public frmVgDictoryname()
        {
            InitializeComponent();
             _objectKey = "VgDictoryname";
            _formName = "frmVgDictoryname";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgDictoryname;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgDictoryname;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgDictoryname;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgDictoryname();
            LinkObject();
        }
