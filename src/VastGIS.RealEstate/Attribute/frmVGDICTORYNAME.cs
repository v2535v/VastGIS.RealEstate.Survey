...
{
    public partial class frmVGDICTORYNAME:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgDictoryname _linkedObject;
        ...
        {
            _linkedObject = _database.DomainService.GetVgDictoryname(id);
            LinkObject();
        }
        ...
        {
            _database.DomainService.SaveVgDictoryname(_linkedObject as VgDictoryname);
        }
    }
