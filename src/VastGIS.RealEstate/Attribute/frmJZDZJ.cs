...
{
    public partial class frmJzdzj:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private Jzdzj _linkedObject;        
        ...
        {
            _linkedObject = _database.ZdService.GetJzdzj(id);
            LinkObject();
        }
        ...
        {
            _database.ZdService.SaveJzdzj(_linkedObject as Jzdzj);
            if(_linkedObject.ID > 0)
            {
