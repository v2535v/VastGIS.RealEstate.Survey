...
{
    public partial class frmZdtojzx:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Zdtojzx _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as Zdtojzx;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as Zdtojzx;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as Zdtojzx;
            LinkObject();
        }
