...
{
    public partial class frmVgLayergroup:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgLayergroup _linkedObject;
        ...
        public frmVgLayergroup()
        {
            InitializeComponent();
             _objectKey = "VgLayergroup";
            _formName = "frmVgLayergroup";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgLayergroup;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgLayergroup;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgLayergroup;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgLayergroup();
            LinkObject();
        }
