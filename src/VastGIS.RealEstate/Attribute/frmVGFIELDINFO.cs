...
{
    public partial class frmVgFieldinfo:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgFieldinfo _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgFieldinfo;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgFieldinfo;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgFieldinfo;
            LinkObject();
        }
