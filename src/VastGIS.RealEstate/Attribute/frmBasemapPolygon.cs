...
namespace VastGIS.Plugins.RealEstate.Attribute
{
    public partial class frmBasemapPolygon:Form,IReAttributeForm
    {
        ...
        private Dxtdldwm _linkedObject;
        ...
        {
            _linkedObject = _database.BasemapService.GetDxtdldwm(id);
            LinkObject();
        }
        ...
        {
            _database.BasemapService.SaveDxtdldwm(_linkedObject as Dxtdldwm);
        }
    }
