...
{
    public partial class frmBasemapPolygon:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private IReFeature _linkedObject;        
        private IAppContext _context;
        private IREDatabase _database;
        #endregion
        
        public frmBasemapPolygon()
        {
            InitializeComponent();
             _objectKey = "BasemapPolygon";
            _formName = "frmBasemapPolygon";
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as IReFeature;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _database.BasemapService.GetBasemapPolygon(tableName,id) as IReFeature;
            LinkObject();
        }
        ...
        {
            _database.BasemapService.SaveBasemapPolygon(_linkedObject as IBasemapPolygon);
            if(_linkedObject.ID > 0)
            {
