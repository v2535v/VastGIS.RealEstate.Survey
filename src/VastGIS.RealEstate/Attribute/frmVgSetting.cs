...
{
    public partial class frmVgSetting:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgSetting _linkedObject;
        ...
        {
            InitializeComponent();
             _objectKey = "VgSetting";
            _formName = "frmVgSetting";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgSetting;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgSetting;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgSetting;
            LinkObject();
        }
