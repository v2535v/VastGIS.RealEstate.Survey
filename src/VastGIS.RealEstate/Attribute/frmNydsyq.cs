...
{
    public partial class frmNydsyq:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Nydsyq _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as Nydsyq;
        }
        ...
        {
            _linkedObject = _list[index] as Nydsyq;
            LinkObject();
        }
