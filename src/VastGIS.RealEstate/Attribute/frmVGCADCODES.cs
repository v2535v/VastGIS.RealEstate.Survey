...
{
    public partial class frmVGCADCODES:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgCadcodes _linkedObject;
        private string _formName;
        private IAppContext _context;
        private IREDatabase _database;

        public frmVGCADCODES()
        {
            InitializeComponent();
            _objectKey = "VGCADCODES";
            _formName = "frmVGCADCODES";
        ...
        {
            _linkedObject = _database.SystemService.GetVgCadcodes(id);
            LinkObject();
        }
        ...
        {
            _database.SystemService.SaveVgCadcodes(_linkedObject as VgCadcodes);
        }
    }
