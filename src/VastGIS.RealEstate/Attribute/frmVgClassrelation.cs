...
{
    public partial class frmVgClassrelation:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgClassrelation _linkedObject;
        ...
        public frmVgClassrelation()
        {
            InitializeComponent();
             _objectKey = "VgClassrelation";
            _formName = "frmVgClassrelation";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgClassrelation;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgClassrelation;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgClassrelation;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgClassrelation();
            LinkObject();
        }
