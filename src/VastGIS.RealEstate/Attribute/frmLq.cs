...
{
    public partial class frmLq:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Lq _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Lq;
            LinkObject();
        }
