...
{
    public partial class frmVgAttachment:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgAttachment _linkedObject;
        ...
        public frmVgAttachment()
        {
            InitializeComponent();
             _objectKey = "VgAttachment";
            _formName = "frmVgAttachment";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgAttachment;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgAttachment;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgAttachment;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgAttachment();
            LinkObject();
        }
