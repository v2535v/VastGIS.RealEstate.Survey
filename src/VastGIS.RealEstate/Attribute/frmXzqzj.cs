...
{
    public partial class frmXzqzj:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private Xzqzj _linkedObject;        
        ...
        {
            _linkedObject = _database.ZdService.GetXzqzj(id);
            LinkObject();
        }
        ...
        {
            _database.ZdService.SaveXzqzj(_linkedObject as Xzqzj);
            if(_linkedObject.ID > 0)
            {
