...
{
    public partial class frmFz:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Fz _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Fz;
            LinkObject();
        }
