...
{
    public partial class frmZdbhqk:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Zdbhqk _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as Zdbhqk;
        }
        ...
        {
            _linkedObject = _list[index] as Zdbhqk;
            LinkObject();
        }
