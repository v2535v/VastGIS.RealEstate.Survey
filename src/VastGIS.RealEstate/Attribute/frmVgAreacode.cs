...
{
    public partial class frmVgAreacode:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgAreacode _linkedObject;
        ...
        public frmVgAreacode()
        {
            InitializeComponent();
             _objectKey = "VgAreacode";
            _formName = "frmVgAreacode";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgAreacode;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgAreacode;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgAreacode;
            LinkObject();
        }
