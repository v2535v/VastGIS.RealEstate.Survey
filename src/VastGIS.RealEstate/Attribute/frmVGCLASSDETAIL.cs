...
{
    public partial class frmVgClassdetail:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgClassdetail _linkedObject;
        ...
        public frmVgClassdetail()
        {
            InitializeComponent();
             _objectKey = "VgClassdetail";
            _formName = "frmVgClassdetail";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgClassdetail;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgClassdetail;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgClassdetail;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgClassdetail();
            LinkObject();
        }
