...
{
    public partial class frmSlsq:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Slsq _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Slsq;
            LinkObject();
        }
