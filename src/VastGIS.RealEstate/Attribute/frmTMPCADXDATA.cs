...
{
    public partial class frmTmpCadxdata:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected TmpCadxdata _linkedObject;
        ...
        public frmTmpCadxdata()
        {
            InitializeComponent();
             _objectKey = "TmpCadxdata";
            _formName = "frmTmpCadxdata";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as TmpCadxdata;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as TmpCadxdata;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as TmpCadxdata;
            LinkObject();
        }
