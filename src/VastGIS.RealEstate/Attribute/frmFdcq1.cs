...
{
    public partial class frmFdcq1:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Fdcq1 _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Fdcq1;
            LinkObject();
        }
