...
{
    public partial class frmSz:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Sz _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Sz;
            LinkObject();
        }
