...
{
    public partial class frmHysyq:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Hysyq _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Hysyq;
            LinkObject();
        }
