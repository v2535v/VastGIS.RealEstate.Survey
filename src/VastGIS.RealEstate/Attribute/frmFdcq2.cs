...
{
    public partial class frmFdcq2:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Fdcq2 _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Fdcq2;
            LinkObject();
        }
