...
{
    public partial class frmSgsj:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Sgsj _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Sgsj;
            LinkObject();
        }
