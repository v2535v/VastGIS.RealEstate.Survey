...
{
    public partial class frmVgCadcode:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgCadcode _linkedObject;
        ...
        {
            InitializeComponent();
             _objectKey = "VgCadcode";
            _formName = "frmVgCadcode";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgCadcode;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgCadcode;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgCadcode;
            LinkObject();
        }
