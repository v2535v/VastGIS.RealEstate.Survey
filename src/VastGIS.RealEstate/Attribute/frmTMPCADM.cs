...
{
    public partial class frmTmpCadm:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private TmpCadm _linkedObject;        
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as TmpCadm;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _database.CadService.GetTmpCadm(id);
            LinkObject();
        }
        ...
        {
            _database.CadService.SaveTmpCadm(_linkedObject as TmpCadm);
            if(_linkedObject.ID > 0)
            {
