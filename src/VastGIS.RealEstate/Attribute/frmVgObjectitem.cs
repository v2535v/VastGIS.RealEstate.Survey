...
{
    public partial class frmVgObjectitem:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgObjectitem _linkedObject;
        ...
        public frmVgObjectitem()
        {
            InitializeComponent();
             _objectKey = "VgObjectitem";
            _formName = "frmVgObjectitem";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgObjectitem;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgObjectitem;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgObjectitem;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgObjectitem();
            LinkObject();
        }
