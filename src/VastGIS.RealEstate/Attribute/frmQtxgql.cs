...
{
    public partial class frmQtxgql:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Qtxgql _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as Qtxgql;
        }
        ...
        {
            _linkedObject = _list[index] as Qtxgql;
            LinkObject();
        }
