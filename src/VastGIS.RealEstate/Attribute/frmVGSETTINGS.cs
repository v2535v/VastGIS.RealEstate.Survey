...
{
    public partial class frmVGSETTINGS:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgSettings _linkedObject;
        private string _formName;
        private IAppContext _context;
        private IREDatabase _database;

        public frmVGSETTINGS()
        {
            InitializeComponent();
            _objectKey = "VGSETTINGS";
            _formName = "frmVGSETTINGS";
        ...
        {
            _linkedObject = _database.SystemService.GetVgSettings(id);
            LinkObject();
        }
        ...
        {
            _database.SystemService.SaveVgSettings(_linkedObject as VgSettings);
        }
    }
