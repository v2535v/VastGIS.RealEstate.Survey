...
{
    public partial class frmVgClassgroup:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgClassgroup _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgClassgroup;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgClassgroup;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgClassgroup;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgClassgroup();
            LinkObject();
        }
