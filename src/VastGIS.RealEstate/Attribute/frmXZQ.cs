...
{
    public partial class frmXzq:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private Xzq _linkedObject;        
        ...
        {
            _linkedObject = _database.ZdService.GetXzq(id);
            LinkObject();
        }
        ...
        {
            _database.ZdService.SaveXzq(_linkedObject as Xzq);
            if(_linkedObject.ID > 0)
            {
