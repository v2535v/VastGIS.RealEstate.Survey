...
{
    public partial class frmZhjbxx:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private Zhjbxx _linkedObject;        
        ...
        {
            _linkedObject = _database.ZdService.GetZhjbxx(id);
            LinkObject();
        }
        ...
        {
            _database.ZdService.SaveZhjbxx(_linkedObject as Zhjbxx);
            if(_linkedObject.ID > 0)
            {
