...
{
    public partial class frmYgdj:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Ygdj _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Ygdj;
            LinkObject();
        }
