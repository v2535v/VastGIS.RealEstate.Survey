...
namespace VastGIS.Plugins.RealEstate.Attribute
{
    partial class frmVGCADCODES
    {
        ...
        {        
            ...
            this.ucLinkObject = new VastGIS.Plugins.RealEstate.DataControls.ucVGCADCODES();
            ...
            this.Name = "frmVGCADCODES";
            this.Text = "VG_CADCODES属性";
        ...
        private DataControls.ucVGCADCODES ucLinkObject;
    }
