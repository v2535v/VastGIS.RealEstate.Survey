...
{
    public partial class frmZdtojzd:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Zdtojzd _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as Zdtojzd;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as Zdtojzd;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as Zdtojzd;
            LinkObject();
        }
