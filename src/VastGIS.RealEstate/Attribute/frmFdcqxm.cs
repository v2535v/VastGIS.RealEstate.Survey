...
{
    public partial class frmFdcqxm:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Fdcqxm _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as Fdcqxm;
        }
        ...
        {
            _linkedObject = _list[index] as Fdcqxm;
            LinkObject();
        }
