...
{
    public partial class frmXzdzw:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private Xzdzw _linkedObject;        
        ...
        {
            _linkedObject = _database.ZdService.GetXzdzw(id);
            LinkObject();
        }
        ...
        {
            _database.ZdService.SaveXzdzw(_linkedObject as Xzdzw);
            if(_linkedObject.ID > 0)
            {
