...
{
    public partial class frmCfdj:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Cfdj _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Cfdj;
            LinkObject();
        }
