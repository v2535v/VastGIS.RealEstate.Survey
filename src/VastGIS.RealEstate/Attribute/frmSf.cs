...
{
    public partial class frmSf:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Sf _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Sf;
            LinkObject();
        }
