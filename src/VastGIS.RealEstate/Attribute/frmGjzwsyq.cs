...
{
    public partial class frmGjzwsyq:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Gjzwsyq _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as Gjzwsyq;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as Gjzwsyq;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as Gjzwsyq;
            LinkObject();
        }
