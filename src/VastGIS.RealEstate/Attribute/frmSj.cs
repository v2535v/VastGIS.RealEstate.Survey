...
{
    public partial class frmSj:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Sj _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Sj;
            LinkObject();
        }
