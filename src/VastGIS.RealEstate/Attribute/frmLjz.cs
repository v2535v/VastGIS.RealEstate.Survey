...
{
    public partial class frmLjz:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Ljz _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Ljz;
            LinkObject();
        }
