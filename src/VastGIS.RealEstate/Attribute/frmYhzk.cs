...
{
    public partial class frmYhzk:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Yhzk _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Yhzk;
            LinkObject();
        }
