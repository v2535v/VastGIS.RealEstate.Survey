...
{
    public partial class frmZj:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private Zj _linkedObject;        
        ...
        {
            _linkedObject = _database.ZdService.GetZj(id);
            LinkObject();
        }
        ...
        {
            _database.ZdService.SaveZj(_linkedObject as Zj);
            if(_linkedObject.ID > 0)
            {
