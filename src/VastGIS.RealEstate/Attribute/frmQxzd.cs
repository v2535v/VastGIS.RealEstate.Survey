...
{
    public partial class frmQxzd:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Qxzd _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Qxzd;
            LinkObject();
        }
