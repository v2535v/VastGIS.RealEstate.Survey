...
{
    public partial class frmMzdzw:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private Mzdzw _linkedObject;        
        ...
        {
            _linkedObject = _database.ZdService.GetMzdzw(id);
            LinkObject();
        }
        ...
        {
            _database.ZdService.SaveMzdzw(_linkedObject as Mzdzw);
            if(_linkedObject.ID > 0)
            {
