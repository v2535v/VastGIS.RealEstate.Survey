...
{
    public partial class frmXzqjx:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private Xzqjx _linkedObject;        
        ...
        {
            _linkedObject = _database.ZdService.GetXzqjx(id);
            LinkObject();
        }
        ...
        {
            _database.ZdService.SaveXzqjx(_linkedObject as Xzqjx);
            if(_linkedObject.ID > 0)
            {
