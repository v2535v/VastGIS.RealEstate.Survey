...
{
    public partial class frmYydj:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Yydj _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Yydj;
            LinkObject();
        }
