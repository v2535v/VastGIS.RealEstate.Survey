...
{
    public partial class frmVgObjectclass:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgObjectclass _linkedObject;
        ...
        public frmVgObjectclass()
        {
            InitializeComponent();
             _objectKey = "VgObjectclass";
            _formName = "frmVgObjectclass";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgObjectclass;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgObjectclass;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgObjectclass;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgObjectclass();
            LinkObject();
        }
