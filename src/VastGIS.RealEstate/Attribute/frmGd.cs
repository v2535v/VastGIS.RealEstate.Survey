...
{
    public partial class frmGd:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Gd _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Gd;
            LinkObject();
        }
