...
namespace VastGIS.Plugins.RealEstate.Attribute
{
    partial class frmVGSETTINGS
    {
        ...
        {        
            ...
            this.ucLinkObject = new VastGIS.Plugins.RealEstate.DataControls.ucVGSETTINGS();
            ...
            this.Name = "frmVGSETTINGS";
            this.Text = "VG_SETTINGS属性";
        ...
        private DataControls.ucVGSETTINGS ucLinkObject;
    }
