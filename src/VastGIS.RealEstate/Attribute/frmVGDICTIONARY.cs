...
{
    public partial class frmVgDictionary:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgDictionary _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgDictionary;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgDictionary;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgDictionary;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgDictionary();
            LinkObject();
        }
