...
namespace VastGIS.Plugins.RealEstate.Attribute
{
    partial class frmVGAREACODES
    {
        ...
        {        
            ...
            this.ucLinkObject = new VastGIS.Plugins.RealEstate.DataControls.ucVGAREACODES();
            ...
            this.Name = "frmVGAREACODES";
            this.Text = "VG_AREACODES属性";
        ...
        private DataControls.ucVGAREACODES ucLinkObject;
    }
