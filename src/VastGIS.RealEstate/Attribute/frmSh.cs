...
{
    public partial class frmSh:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Sh _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Sh;
            LinkObject();
        }
