...
{
    public partial class frmVGLAYERGROUPDETAIL:Form,IReAttributeForm
    {
        private string _objectKey;
        private VgLayergroupdetail _linkedObject;
        ...
        {
            _linkedObject = _database.SystemService.GetVgLayergroupdetail(id);
            LinkObject();
        }
        ...
        {
            _database.SystemService.SaveVgLayergroupdetail(_linkedObject as VgLayergroupdetail);
        }
    }
