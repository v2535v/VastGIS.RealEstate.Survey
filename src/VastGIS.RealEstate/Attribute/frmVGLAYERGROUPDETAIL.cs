...
{
    public partial class frmVgLayergroupdetail:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgLayergroupdetail _linkedObject;
        ...
        public frmVgLayergroupdetail()
        {
            InitializeComponent();
             _objectKey = "VgLayergroupdetail";
            _formName = "frmVgLayergroupdetail";
        }
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgLayergroupdetail;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgLayergroupdetail;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgLayergroupdetail;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgLayergroupdetail();
            LinkObject();
        }
