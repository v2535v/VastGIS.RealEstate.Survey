...
{
    public partial class frmTmpCadzj:Form,IReAttributeForm
    {	
        #region 变量
        private string _objectKey;
        private string _formName;
        private TmpCadzj _linkedObject;        
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as TmpCadzj;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _database.CadService.GetTmpCadzj(id);
            LinkObject();
        }
        ...
        {
            _database.CadService.SaveTmpCadzj(_linkedObject as TmpCadzj);
            if(_linkedObject.ID > 0)
            {
