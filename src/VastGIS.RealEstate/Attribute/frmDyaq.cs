...
{
    public partial class frmDyaq:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Dyaq _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Dyaq;
            LinkObject();
        }
