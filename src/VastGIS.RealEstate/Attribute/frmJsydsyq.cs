...
{
    public partial class frmJsydsyq:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Jsydsyq _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as Jsydsyq;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as Jsydsyq;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as Jsydsyq;
            LinkObject();
        }
