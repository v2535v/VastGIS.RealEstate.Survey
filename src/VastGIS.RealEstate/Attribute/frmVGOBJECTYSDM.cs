...
{
    public partial class frmVgObjectysdm:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected VgObjectysdm _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as VgObjectysdm;
        }
        ...
        public IEntity LinkedObject
        {
            ...
            set{
                _linkedObject=value as VgObjectysdm;
                LinkObject();
            }            
        }
        ...
        {
            _linkedObject = _list[index] as VgObjectysdm;
            LinkObject();
        }
        ...
        {
            _isNew = true;
            _linkedObject=new VgObjectysdm();
            LinkObject();
        }
