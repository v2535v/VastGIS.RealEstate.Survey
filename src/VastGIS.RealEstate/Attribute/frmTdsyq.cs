...
{
    public partial class frmTdsyq:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Tdsyq _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Tdsyq;
            LinkObject();
        }
