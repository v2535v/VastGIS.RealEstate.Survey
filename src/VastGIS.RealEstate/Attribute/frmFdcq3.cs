...
{
    public partial class frmFdcq3:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Fdcq3 _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Fdcq3;
            LinkObject();
        }
