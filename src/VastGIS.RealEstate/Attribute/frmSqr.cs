...
{
    public partial class frmSqr:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Sqr _linkedObject;
        ...
        {
            _linkedObject = _list[index] as Sqr;
            LinkObject();
        }
