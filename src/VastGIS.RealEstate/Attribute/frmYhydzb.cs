...
{
    public partial class frmYhydzb:Form,IAttributeForm
    {	
        #region 变量
        protected string _objectKey;
        protected string _formName;
        protected Yhydzb _linkedObject;
        ...
        public void BindContext(IAppContext context,IEntity entity)
        {
            ...
            _linkedObject=entity as Yhydzb;
        }
        ...
        {
            _linkedObject = _list[index] as Yhydzb;
            LinkObject();
        }
