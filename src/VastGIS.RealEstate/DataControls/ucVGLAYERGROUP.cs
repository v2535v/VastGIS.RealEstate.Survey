...
namespace VastGIS.Plugins.RealEstate.DataControls
{
    ...
    public partial class ucVGLAYERGROUP:UserControl
    {
        ...
        public void LinkObject(IREDatabase database,VgLayergroup vg_layergroup)
        {
            _database = database;
            ...
            intID.DataBindings.Add("IntegerValue",vg_layergroup,"ID");
            txtZM.DataBindings.Clear();
            txtZM.DataBindings.Add("Text",vg_layergroup,"Zm");
        }
