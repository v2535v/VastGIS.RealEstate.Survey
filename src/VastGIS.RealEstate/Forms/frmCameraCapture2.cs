...
{
    public delegate void SaveComplateHandle(VgAttachment attachment);
    public partial class frmCameraCapture2 : Form
    {
        #region Vars

        public event SaveComplateHandle SaveComplateEvent;
        ...
        public frmCameraCapture2(IAppContext context, RealEstateEditor plugin)
        {
            InitializeComponent();
            _context = context;
            _plugin = plugin;
        ...
        */
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (_currentImage == null)
                return;
            GetAttachment();
            OnSaveComplateEvent(_attachment);
            _currentImage = null;
            //cameraControl.CloseCamera();
            //DialogResult = DialogResult.OK;
        }

        protected virtual void OnSaveComplateEvent(VgAttachment attachment)
        {
            SaveComplateEvent?.Invoke(attachment);
        }
    }
}
