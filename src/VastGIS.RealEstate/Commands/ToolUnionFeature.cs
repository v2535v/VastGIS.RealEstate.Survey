...
{
    public class ToolUnionFeature : BaseTool
    {
        private IAppContext _context;
        private IEditForm _editForm;
        private RealEstateEditor _plugin;

        public ToolUnionFeature(IAppContext context, RealEstateEditor plugin)
        {
            _plugin = plugin;
            _context = context;
            base._text = "要素合并";
            base._key = MenuKeys.UnionFeature;
            base._icon = Resources.FeatureUnion;
        ...
        public override void Activiate()
        {
            ...
            {
                _editForm = new frmUnionGeometry(_context, _plugin);
