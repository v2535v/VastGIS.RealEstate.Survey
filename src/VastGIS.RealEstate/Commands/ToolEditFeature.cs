...
{
    public class ToolEditFeature : BaseTool
    {
        private IAppContext _context;
        private IEditForm _editForm;
        private RealEstateEditor _plugin;

        public ToolEditFeature(IAppContext context, RealEstateEditor plugin)
        {
            _plugin = plugin;
            _context = context;
            base._text = "要素编辑";
            base._key = MenuKeys.EditFeature;
        ...
        public override void Activiate()
        {
            ...
            {
                _editForm = new frmEditFeature(_context, _plugin);
