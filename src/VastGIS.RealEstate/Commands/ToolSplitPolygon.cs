...
{
    public class ToolSplitPolygon : BaseTool
    {
        private IAppContext _context;
        private IEditForm _editForm;
        private RealEstateEditor _plugin;

        public ToolSplitPolygon(IAppContext context, RealEstateEditor plugin)
        {
            _plugin = plugin;
            _context = context;
            base._text = "多边形分割";
            base._key = MenuKeys.SplitPolygon;
            base._icon = Resources.img_splitpolygon;
        ...
        public override void Activiate()
        {
            ...
            {
                _editForm = new frmSplitPolygon(_context, _plugin);
