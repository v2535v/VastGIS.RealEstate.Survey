...
namespace VastGIS.RealEstate.Data.Entity
{
    ...
    public partial class Jzdzj:INotifyPropertyChanging, INotifyPropertyChanged,IDatabaseEntity
    {
	    ...
	    private const string SQL_INSERT_JZDZJ = "INSERT INTO JZDZJ (GLYSDM, YSDM, ZJNR, ZT, YS, BS, XZ, XHX, KD, GD, ZJDZXJXZB, ZJDZXJYZB, ZJFX, DatabaseId, FLAGS, geometry) VALUES ( @GLYSDM, @YSDM, @ZJNR, @ZT, @YS, @BS, @XZ, @XHX, @KD, @GD, @ZJDZXJXZB, @ZJDZXJYZB, @ZJFX, @DatabaseId, @FLAGS, GeomFromText(@geometry,@SRID));" + " SELECT last_insert_rowid();";
