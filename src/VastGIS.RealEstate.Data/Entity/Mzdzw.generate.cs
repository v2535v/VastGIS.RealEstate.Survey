...
{
    public partial class Mzdzw : INotifyPropertyChanging, INotifyPropertyChanged,ISurveyFeature,IYsdmEntity,IGlobalEntity
    {		
		#region 表结构		
        public const string TABLE_NAME = "MZDZW";	
        public const string LAYER_NAME = "面状定着物";	
		...
		public const string COL_MZDZWLX = "MZDZWLX";
		public const string COL_DZWMC = "DZWMC";
		public const string COL_MJDW = "MJDW";
		public const string COL_MJ = "MJ";
        ...
        public const string PARAM_MZDZWLX = "@MZDZWLX";	
        public const string PARAM_DZWMC = "@DZWMC";	
        public const string PARAM_MJDW = "@MJDW";	
        public const string PARAM_MJ = "@MJ";	
		...
		#region SQL语句
		private const string SQL_QUERY_MZDZW ="SELECT  Id,YSDM,BDCDYH,ZDZHDM,MZDZWLX,DZWMC,MJDW,MJ,DAH,ZT,WX_DCY,WX_DCSJ,WX_CLY,WX_CLSJ,WX_ZTY,WX_ZTSJ,WX_ZJY,WX_ZJSJ,WX_WYDM,DatabaseId,FLAGS,XGR,XGSJ,AsText(geometry) as Wkt FROM MZDZW WHERE [FLAGS]<3";
        
		private const string SQL_INSERT_MZDZW = "INSERT INTO [MZDZW] (YSDM, BDCDYH, ZDZHDM, MZDZWLX, DZWMC, MJDW, MJ, DAH, ZT, WX_DCY, WX_DCSJ, WX_CLY, WX_CLSJ, WX_ZTY, WX_ZTSJ, WX_ZJY, WX_ZJSJ, WX_WYDM, DatabaseId, FLAGS, XGR, XGSJ, geometry) VALUES ( @YSDM, @BDCDYH, @ZDZHDM, @MZDZWLX, @DZWMC, @MJDW, @MJ, @DAH, @ZT, @WX_DCY, @WX_DCSJ, @WX_CLY, @WX_CLSJ, @WX_ZTY, @WX_ZTSJ, @WX_ZJY, @WX_ZJSJ, @WX_WYDM, @DatabaseId, @FLAGS, @XGR, @XGSJ, GeomFromText(@geometry,@SRID));" + " SELECT last_insert_rowid();";
		
		private const string SQL_UPDATE_MZDZW = "UPDATE [MZDZW] SET YSDM = @YSDM, BDCDYH = @BDCDYH, ZDZHDM = @ZDZHDM, MZDZWLX = @MZDZWLX, DZWMC = @DZWMC, MJDW = @MJDW, MJ = @MJ, DAH = @DAH, ZT = @ZT, WX_DCY = @WX_DCY, WX_DCSJ = @WX_DCSJ, WX_CLY = @WX_CLY, WX_CLSJ = @WX_CLSJ, WX_ZTY = @WX_ZTY, WX_ZTSJ = @WX_ZTSJ, WX_ZJY = @WX_ZJY, WX_ZJSJ = @WX_ZJSJ, WX_WYDM = @WX_WYDM, DatabaseId = @DatabaseId, FLAGS = @FLAGS, XGR = @XGR, XGSJ = @XGSJ,  geometry = GeomFromText(@geometry,@SRID) WHERE Id = @Id";
		
		private const string SQL_DELETE_MZDZW = "DELETE FROM [MZDZW] WHERE  Id = @Id ";
		
        private const string SQL_DELETE_FLAG_MZDZW = "UPDATE [MZDZW] Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE WHERE  Id = @Id ";
        #endregion
        ...
        ///面状定着物类型
		protected string mzdzwlx = default(string);
        ///定着物名称
		protected string dzwmc = default(string);
        ///面积单位[字典:面积单位字典表-MJDWZD]
		protected string mjdw = default(string);
        ///面积
		protected double? mj = default(double?);
        ///档案号
        ...
        public string SimpleLabelString
        {
            get
            {
                return string.Format("{0} {1} ({2})","MZDZW",this.id,this.ysdm);
            }
        }
        ...
        public string FullLabelString
        {
            get
            {
                return string.Format("{0} {1} ({2})","面状定着物",this.id,this.ysdm);
            }
        }        
        #endregion
        ...
        ///面状定着物类型
        ///[Column(COL_MZDZWLX, PARAM_MZDZWLX )]
        public virtual string Mzdzwlx 
        {
            get { return this.mzdzwlx; }
			set	{ 
                  if(this.mzdzwlx != value)
                    {
                        this.OnPropertyChanging("Mzdzwlx"); 
                        this.mzdzwlx = value;                        
                        this.OnPropertyChanged("Mzdzwlx");
                    }   
                }
        }	
		
        ///定着物名称
        ///[Column(COL_DZWMC, PARAM_DZWMC )]
        public virtual string Dzwmc 
        {
            get { return this.dzwmc; }
			set	{ 
                  if(this.dzwmc != value)
                    {
                        this.OnPropertyChanging("Dzwmc"); 
                        this.dzwmc = value;                        
                        this.OnPropertyChanged("Dzwmc");
                    }   
                }
        }	
        ...
        public virtual double? Mj 
        {
			...
			set	{ 
                  if(this.mj != value)
                    {
                        this.OnPropertyChanging("Mj"); 
                        this.mj = value;                        
                        this.OnPropertyChanged("Mj");
                    }   
                }
        }	
       ...
       public IGeometry Geometry
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_INSERT_MZDZW,dao.Connection))
            {
                this.databaseid=0;
                this.flags=1;
				...
				command.Parameters.AddWithValue(PARAM_MZDZWLX, this.Mzdzwlx);
				command.Parameters.AddWithValue(PARAM_DZWMC, this.Dzwmc);
				command.Parameters.AddWithValue(PARAM_MJDW, this.Mjdw);
				command.Parameters.AddWithValue(PARAM_MJ, this.Mj);
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_UPDATE_MZDZW,dao.Connection))
            {
        ...
        public bool Delete(ISQLiteService dao)
        {
            if(this.databaseid==0)
            {
                using(SQLiteCommand command  = new SQLiteCommand(SQL_DELETE_MZDZW,dao.Connection))
                {                   
    				command.Parameters.AddWithValue(PARAM_ID, this.ID);
                    return (command.ExecuteNonQuery() == 1);
                }
            ...
            {
                using(SQLiteCommand command  = new SQLiteCommand(SQL_DELETE_FLAG_MZDZW,dao.Connection))
                {
        ...
        public void  LoadFromReader(SQLiteDataReader reader)
        {
			...
			if (!reader.IsDBNull(3)) zdzhdm = reader.GetString(3);
			if (!reader.IsDBNull(4)) mzdzwlx = reader.GetString(4);
			if (!reader.IsDBNull(5)) dzwmc = reader.GetString(5);
			if (!reader.IsDBNull(6)) mjdw = reader.GetString(6);
			if (!reader.IsDBNull(7)) mj = reader.GetDouble(7);
			if (!reader.IsDBNull(8)) dah = reader.GetString(8);
			if (!reader.IsDBNull(9)) zt = reader.GetString(9);
			...
			if (!reader.IsDBNull(23)) this.Wkt=reader.GetString(23);
        }
        
        #region 拷贝
        public IEntity Copy()
        {
            Mzdzw target=new Mzdzw();
            target.ID=0;
            target.Ysdm=this.Ysdm;
            target.Bdcdyh=this.Bdcdyh;
            target.Zdzhdm=this.Zdzhdm;
            target.Mzdzwlx=this.Mzdzwlx;
            target.Dzwmc=this.Dzwmc;
