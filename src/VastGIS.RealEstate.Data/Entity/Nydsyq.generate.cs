...
{
    public partial class Nydsyq : INotifyPropertyChanging, INotifyPropertyChanged,IDatabaseEntity,IYsdmEntity,IGlobalEntity,ISurveyEntity
    {		
		#region 表结构		
        public const string TABLE_NAME = "NYDSYQ";	
        public const string LAYER_NAME = "农用地使用权（非林地）";	
		...
		public const string COL_FBFDM = "FBFDM";
		public const string COL_FBFMC = "FBFMC";
		public const string COL_CBMJ = "CBMJ";
		public const string COL_CBQSSJ = "CBQSSJ";
		public const string COL_CBJSSJ = "CBJSSJ";
		public const string COL_TDSYQXZ = "TDSYQXZ";
		public const string COL_SYTTLX = "SYTTLX";
		public const string COL_YZYFS = "YZYFS";
		public const string COL_CYZL = "CYZL";
		public const string COL_SYZCL = "SYZCL";
        ...
        public const string PARAM_FBFDM = "@FBFDM";	
        public const string PARAM_FBFMC = "@FBFMC";	
        public const string PARAM_CBMJ = "@CBMJ";	
        public const string PARAM_CBQSSJ = "@CBQSSJ";	
        public const string PARAM_CBJSSJ = "@CBJSSJ";	
        public const string PARAM_TDSYQXZ = "@TDSYQXZ";	
        public const string PARAM_SYTTLX = "@SYTTLX";	
        public const string PARAM_YZYFS = "@YZYFS";	
        public const string PARAM_CYZL = "@CYZL";	
        public const string PARAM_SYZCL = "@SYZCL";	
		...
		#region SQL语句
		private const string SQL_QUERY_NYDSYQ ="SELECT  Id,YSDM,BDCDYH,YWH,QLLX,DJLX,DJYY,ZL,FBFDM,FBFMC,CBMJ,CBQSSJ,CBJSSJ,TDSYQXZ,SYTTLX,YZYFS,CYZL,SYZCL,BDCQZH,QXDM,DJJG,DBR,DJSJ,FJ,QSZT,WX_DCY,WX_DCSJ,WX_CLY,WX_CLSJ,WX_ZTY,WX_ZTSJ,WX_ZJY,WX_ZJSJ,WX_WYDM,DatabaseId,FLAGS,XGR,XGSJ FROM NYDSYQ WHERE [FLAGS]<3";
        
		private const string SQL_INSERT_NYDSYQ = "INSERT INTO [NYDSYQ] (YSDM, BDCDYH, YWH, QLLX, DJLX, DJYY, ZL, FBFDM, FBFMC, CBMJ, CBQSSJ, CBJSSJ, TDSYQXZ, SYTTLX, YZYFS, CYZL, SYZCL, BDCQZH, QXDM, DJJG, DBR, DJSJ, FJ, QSZT, WX_DCY, WX_DCSJ, WX_CLY, WX_CLSJ, WX_ZTY, WX_ZTSJ, WX_ZJY, WX_ZJSJ, WX_WYDM, DatabaseId, FLAGS, XGR, XGSJ) VALUES ( @YSDM, @BDCDYH, @YWH, @QLLX, @DJLX, @DJYY, @ZL, @FBFDM, @FBFMC, @CBMJ, @CBQSSJ, @CBJSSJ, @TDSYQXZ, @SYTTLX, @YZYFS, @CYZL, @SYZCL, @BDCQZH, @QXDM, @DJJG, @DBR, @DJSJ, @FJ, @QSZT, @WX_DCY, @WX_DCSJ, @WX_CLY, @WX_CLSJ, @WX_ZTY, @WX_ZTSJ, @WX_ZJY, @WX_ZJSJ, @WX_WYDM, @DatabaseId, @FLAGS, @XGR, @XGSJ);" + " SELECT last_insert_rowid();";
		
		private const string SQL_UPDATE_NYDSYQ = "UPDATE [NYDSYQ] SET YSDM = @YSDM, BDCDYH = @BDCDYH, YWH = @YWH, QLLX = @QLLX, DJLX = @DJLX, DJYY = @DJYY, ZL = @ZL, FBFDM = @FBFDM, FBFMC = @FBFMC, CBMJ = @CBMJ, CBQSSJ = @CBQSSJ, CBJSSJ = @CBJSSJ, TDSYQXZ = @TDSYQXZ, SYTTLX = @SYTTLX, YZYFS = @YZYFS, CYZL = @CYZL, SYZCL = @SYZCL, BDCQZH = @BDCQZH, QXDM = @QXDM, DJJG = @DJJG, DBR = @DBR, DJSJ = @DJSJ, FJ = @FJ, QSZT = @QSZT, WX_DCY = @WX_DCY, WX_DCSJ = @WX_DCSJ, WX_CLY = @WX_CLY, WX_CLSJ = @WX_CLSJ, WX_ZTY = @WX_ZTY, WX_ZTSJ = @WX_ZTSJ, WX_ZJY = @WX_ZJY, WX_ZJSJ = @WX_ZJSJ, WX_WYDM = @WX_WYDM, DatabaseId = @DatabaseId, FLAGS = @FLAGS, XGR = @XGR, XGSJ = @XGSJ WHERE Id = @Id";
		
		private const string SQL_DELETE_NYDSYQ = "DELETE FROM [NYDSYQ] WHERE  Id = @Id ";
		
        private const string SQL_DELETE_FLAG_NYDSYQ = "UPDATE [NYDSYQ] Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE WHERE  Id = @Id ";
        #endregion
        ...
        ///发包方代码
		protected string fbfdm = default(string);
        ///发包方名称
		protected string fbfmc = default(string);
        ///承包（使用权）面积
		protected double? cbmj = default(double?);
        ///承包(使用)起始时间
		protected System.DateTime? cbqssj = default(System.DateTime?);
        ///承包(使用)结束时间
		protected System.DateTime? cbjssj = default(System.DateTime?);
        ///土地所有权性质[字典:土地所有权性质字典表-TDSYQXZZD]
		protected string tdsyqxz = default(string);
        ///水域滩涂类型[字典:水域滩涂类型字典表-SYTTLXZD]
		protected string syttlx = default(string);
        ///养殖业方式[字典:养殖业方式字典表-YZYFSZD]
		protected string yzyfs = default(string);
        ///草原质量
		protected string cyzl = default(string);
        ///适宜载畜量
		protected long? syzcl = default(long?);
        ///不动产权证号
        ...
        public string SimpleLabelString
        {
            get
            {
                return string.Format("{0} {1} ({2})","NYDSYQ",this.id,this.ysdm);
            }
        }
        ...
        public string FullLabelString
        {
            get
            {
                return string.Format("{0} {1} ({2})","农用地使用权（非林地）",this.id,this.ysdm);
            }
        }        
        #endregion
        ...
        ///发包方代码
        ///[Column(COL_FBFDM, PARAM_FBFDM )]
        public virtual string Fbfdm 
        {
            get { return this.fbfdm; }
			set	{ 
                  if(this.fbfdm != value)
                    {
                        this.OnPropertyChanging("Fbfdm"); 
                        this.fbfdm = value;                        
                        this.OnPropertyChanged("Fbfdm");
                    }   
                }
        }	
		
        ///发包方名称
        ///[Column(COL_FBFMC, PARAM_FBFMC )]
        public virtual string Fbfmc 
        {
            get { return this.fbfmc; }
			set	{ 
                  if(this.fbfmc != value)
                    {
                        this.OnPropertyChanging("Fbfmc"); 
                        this.fbfmc = value;                        
                        this.OnPropertyChanged("Fbfmc");
                    }   
                }
        }	
		
        ///承包（使用权）面积
        ///[Column(COL_CBMJ, PARAM_CBMJ )]
        public virtual double? Cbmj 
        {
            get { return this.cbmj; }
			set	{ 
                  if(this.cbmj != value)
                    {
                        this.OnPropertyChanging("Cbmj"); 
                        this.cbmj = value;                        
                        this.OnPropertyChanged("Cbmj");
                    }   
                }
        }	
		
        ///承包(使用)起始时间
        ///[Column(COL_CBQSSJ, PARAM_CBQSSJ )]
        public virtual System.DateTime? Cbqssj 
        {
            get { return this.cbqssj; }
			set	{ 
                  if(this.cbqssj != value)
                    {
                        this.OnPropertyChanging("Cbqssj"); 
                        this.cbqssj = value;                        
                        this.OnPropertyChanged("Cbqssj");
                    }   
                }
        }	
		
        ///承包(使用)结束时间
        ///[Column(COL_CBJSSJ, PARAM_CBJSSJ )]
        public virtual System.DateTime? Cbjssj 
        {
            get { return this.cbjssj; }
			set	{ 
                  if(this.cbjssj != value)
                    {
                        this.OnPropertyChanging("Cbjssj"); 
                        this.cbjssj = value;                        
                        this.OnPropertyChanged("Cbjssj");
                    }   
                }
        }	
		
        ///土地所有权性质
        ///[Column(COL_TDSYQXZ, PARAM_TDSYQXZ )]
        public virtual string Tdsyqxz 
        {
            get { return this.tdsyqxz; }
			set	{ 
                  if(this.tdsyqxz != value)
                    {
                        this.OnPropertyChanging("Tdsyqxz"); 
                        this.tdsyqxz = value;                        
                        this.OnPropertyChanged("Tdsyqxz");
                    }   
                }
        }	
		
        ///水域滩涂类型
        ///[Column(COL_SYTTLX, PARAM_SYTTLX )]
        public virtual string Syttlx 
        {
            get { return this.syttlx; }
			set	{ 
                  if(this.syttlx != value)
                    {
                        this.OnPropertyChanging("Syttlx"); 
                        this.syttlx = value;                        
                        this.OnPropertyChanged("Syttlx");
                    }   
                }
        }	
		
        ///养殖业方式
        ///[Column(COL_YZYFS, PARAM_YZYFS )]
        public virtual string Yzyfs 
        {
            get { return this.yzyfs; }
			set	{ 
                  if(this.yzyfs != value)
                    {
                        this.OnPropertyChanging("Yzyfs"); 
                        this.yzyfs = value;                        
                        this.OnPropertyChanged("Yzyfs");
                    }   
                }
        }	
		
        ///草原质量
        ///[Column(COL_CYZL, PARAM_CYZL )]
        public virtual string Cyzl 
        {
            get { return this.cyzl; }
			set	{ 
                  if(this.cyzl != value)
                    {
                        this.OnPropertyChanging("Cyzl"); 
                        this.cyzl = value;                        
                        this.OnPropertyChanged("Cyzl");
                    }   
                }
        }	
		
        ///适宜载畜量
        ///[Column(COL_SYZCL, PARAM_SYZCL )]
        public virtual long? Syzcl 
        {
            get { return this.syzcl; }
			set	{ 
                  if(this.syzcl != value)
                    {
                        this.OnPropertyChanging("Syzcl"); 
                        this.syzcl = value;                        
                        this.OnPropertyChanged("Syzcl");
                    }   
                }
        }	
       ...
       ///图形类型
        ...
        public Nydsyq()
        {
            ...
            this.fbfmc="";
            this.cbmj=0.0;
            this.cbqssj=DateTime.Now;
            this.cbjssj=DateTime.Now;
            this.tdsyqxz="";
            this.syttlx="";
            this.yzyfs="";
            this.cyzl="";
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_INSERT_NYDSYQ,dao.Connection))
            {
                this.databaseid=0;
                this.flags=1;
				...
				command.Parameters.AddWithValue(PARAM_FBFDM, this.Fbfdm);
				command.Parameters.AddWithValue(PARAM_FBFMC, this.Fbfmc);
				command.Parameters.AddWithValue(PARAM_CBMJ, this.Cbmj);
				command.Parameters.AddWithValue(PARAM_CBQSSJ, this.Cbqssj);
				command.Parameters.AddWithValue(PARAM_CBJSSJ, this.Cbjssj);
				command.Parameters.AddWithValue(PARAM_TDSYQXZ, this.Tdsyqxz);
				command.Parameters.AddWithValue(PARAM_SYTTLX, this.Syttlx);
				command.Parameters.AddWithValue(PARAM_YZYFS, this.Yzyfs);
				command.Parameters.AddWithValue(PARAM_CYZL, this.Cyzl);
				command.Parameters.AddWithValue(PARAM_SYZCL, this.Syzcl);
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_UPDATE_NYDSYQ,dao.Connection))
            {
        ...
        public bool Delete(ISQLiteService dao)
        {
            if(this.databaseid==0)
            {
                using(SQLiteCommand command  = new SQLiteCommand(SQL_DELETE_NYDSYQ,dao.Connection))
                {                   
    				command.Parameters.AddWithValue(PARAM_ID, this.ID);
                    return (command.ExecuteNonQuery() == 1);
                }
            ...
            {
                using(SQLiteCommand command  = new SQLiteCommand(SQL_DELETE_FLAG_NYDSYQ,dao.Connection))
                {
        ...
        public void  LoadFromReader(SQLiteDataReader reader)
        {
			...
			if (!reader.IsDBNull(8)) fbfdm = reader.GetString(8);
			if (!reader.IsDBNull(9)) fbfmc = reader.GetString(9);
			if (!reader.IsDBNull(10)) cbmj = reader.GetDouble(10);
			if (!reader.IsDBNull(11)) cbqssj = reader.GetDateTime(11);
			if (!reader.IsDBNull(12)) cbjssj = reader.GetDateTime(12);
			if (!reader.IsDBNull(13)) tdsyqxz = reader.GetString(13);
			if (!reader.IsDBNull(14)) syttlx = reader.GetString(14);
			if (!reader.IsDBNull(15)) yzyfs = reader.GetString(15);
			if (!reader.IsDBNull(16)) cyzl = reader.GetString(16);
			if (!reader.IsDBNull(17)) syzcl = reader.GetInt64(17);
			if (!reader.IsDBNull(18)) bdcqzh = reader.GetString(18);
			if (!reader.IsDBNull(19)) qxdm = reader.GetString(19);
			if (!reader.IsDBNull(20)) djjg = reader.GetString(20);
			if (!reader.IsDBNull(21)) dbr = reader.GetString(21);
			if (!reader.IsDBNull(22)) djsj = reader.GetDateTime(22);
			if (!reader.IsDBNull(23)) fj = reader.GetString(23);
			if (!reader.IsDBNull(24)) qszt = reader.GetString(24);
			if (!reader.IsDBNull(25)) wxDcy = reader.GetString(25);
			if (!reader.IsDBNull(26)) wxDcsj = reader.GetDateTime(26);
			if (!reader.IsDBNull(27)) wxCly = reader.GetString(27);
			if (!reader.IsDBNull(28)) wxClsj = reader.GetDateTime(28);
			if (!reader.IsDBNull(29)) wxZty = reader.GetString(29);
			if (!reader.IsDBNull(30)) wxZtsj = reader.GetDateTime(30);
			if (!reader.IsDBNull(31)) wxZjy = reader.GetString(31);
			if (!reader.IsDBNull(32)) wxZjsj = reader.GetDateTime(32);
			if (!reader.IsDBNull(33)) wxWydm = reader.GetString(33);
			if (!reader.IsDBNull(34)) databaseid = reader.GetInt64(34);
			if (!reader.IsDBNull(35)) flags = reader.GetInt16(35);
			if (!reader.IsDBNull(36)) xgr = reader.GetString(36);
			if (!reader.IsDBNull(37)) xgsj = reader.GetDateTime(37);
        }
        
        #region 拷贝
        public IEntity Copy()
        {
            Nydsyq target=new Nydsyq();
            target.ID=0;
            ...
            target.Zl=this.Zl;
            target.Fbfdm=this.Fbfdm;
            target.Fbfmc=this.Fbfmc;
            target.Cbmj=this.Cbmj;
            target.Cbqssj=this.Cbqssj;
            target.Cbjssj=this.Cbjssj;
            target.Tdsyqxz=this.Tdsyqxz;
            target.Syttlx=this.Syttlx;
            target.Yzyfs=this.Yzyfs;
            target.Cyzl=this.Cyzl;
            target.Syzcl=this.Syzcl;
