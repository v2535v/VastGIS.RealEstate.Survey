...
namespace VastGIS.RealEstate.Data.Entity
{
    ...
    public partial class Dxtzjx:INotifyPropertyChanging, INotifyPropertyChanged
    {
        #region 表结构
	    ...
	    private const string SQL_INSERT_DXTZJX = "INSERT INTO DXTZJX (TC, CASSDM, FH, FHDX, FSXX1, FSXX2, YSDM, geometry) VALUES ( @TC, @CASSDM, @FH, @FHDX, @FSXX1, @FSXX2, @YSDM, GeomFromText(@geometry,@SRID));" + " SELECT last_insert_rowid();";
	
	    private const string SQL_UPDATE_DXTZJX = "UPDATE DXTZJX SET TC = @TC, CASSDM = @CASSDM, FH = @FH, FHDX = @FHDX, FSXX1 = @FSXX1, FSXX2 = @FSXX2, YSDM = @YSDM, geometry = GeomFromText(@geometry,@SRID) WHERE Id = @Id";
