...
namespace VastGIS.RealEstate.Data.Entity
{
    ...
    public partial class TmpCadzj:INotifyPropertyChanging, INotifyPropertyChanged
    {
        #region 表结构
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_INSERT_TMPCADZJ,connection))
            {	
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_UPDATE_TMPCADZJ,connection))
            {							
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_DELETE_TMPCADZJ,connection))
            {							
				command.Parameters.AddWithValue(PARAM_ID, this.ID);
                return (command.ExecuteNonQuery() == 1);
            }
