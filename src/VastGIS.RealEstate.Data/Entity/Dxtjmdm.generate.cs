...
namespace VastGIS.RealEstate.Data.Entity
{
    ...
    public partial class Dxtjmdm:INotifyPropertyChanging, INotifyPropertyChanged
    {
        #region 表结构
	    ...
	    private const string SQL_INSERT_DXTJMDM = "INSERT INTO DXTJMDM (TC, CASSDM, FSXX1, FSXX2, YSDM, geometry) VALUES ( @TC, @CASSDM, @FSXX1, @FSXX2, @YSDM, GeomFromText(@geometry,@SRID));" + " SELECT last_insert_rowid();";
	
	    private const string SQL_UPDATE_DXTJMDM = "UPDATE DXTJMDM SET TC = @TC, CASSDM = @CASSDM, FSXX1 = @FSXX1, FSXX2 = @FSXX2, YSDM = @YSDM, geometry = GeomFromText(@geometry,@SRID) WHERE Id = @Id";
