...
namespace VastGIS.RealEstate.Data.Entity
{
    ...
    public partial class Dxtqtm:INotifyPropertyChanging, INotifyPropertyChanged,IDatabaseEntity,IBasemapPolygon
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_DXTQTM = "UPDATE DXTQTM Set Flags=3 WHERE  Id = @Id ";
		...
		public bool Delete(SQLiteConnection connection)
        {
            ...
            {
                using(SQLiteCommand command  = new SQLiteCommand(SQL_DELETE_FLAG_DXTQTM,connection))
                {
