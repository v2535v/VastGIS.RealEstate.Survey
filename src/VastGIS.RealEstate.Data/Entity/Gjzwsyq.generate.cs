...
{
    public partial class Gjzwsyq : INotifyPropertyChanging, INotifyPropertyChanged,IDatabaseEntity,IYsdmEntity,IGlobalEntity,ISurveyEntity
    {		
		#region 表结构		
        public const string TABLE_NAME = "GJZWSYQ";	
        public const string LAYER_NAME = "构（建）筑物所有权";	
		...
		public const string COL_TDHYSYQR = "TDHYSYQR";
		public const string COL_TDHYSYMJ = "TDHYSYMJ";
		public const string COL_TDHYSYQSSJ = "TDHYSYQSSJ";
		public const string COL_TDHYSYJSSJ = "TDHYSYJSSJ";
		public const string COL_GJZWLX = "GJZWLX";
		public const string COL_GJZWGHYT = "GJZWGHYT";
		public const string COL_GJZWMJ = "GJZWMJ";
		...
		public const string COL_GJZWPMT = "GJZWPMT";
        ...
        public const string PARAM_TDHYSYQR = "@TDHYSYQR";	
        public const string PARAM_TDHYSYMJ = "@TDHYSYMJ";	
        public const string PARAM_TDHYSYQSSJ = "@TDHYSYQSSJ";	
        public const string PARAM_TDHYSYJSSJ = "@TDHYSYJSSJ";	
        public const string PARAM_GJZWLX = "@GJZWLX";	
        public const string PARAM_GJZWGHYT = "@GJZWGHYT";	
        public const string PARAM_GJZWMJ = "@GJZWMJ";	
        ...
        public const string PARAM_GJZWPMT = "@GJZWPMT";	
		...
		#region SQL语句
		private const string SQL_QUERY_GJZWSYQ ="SELECT  Id,YSDM,BDCDYH,YWH,QLLX,DJLX,DJYY,ZL,TDHYSYQR,TDHYSYMJ,TDHYSYQSSJ,TDHYSYJSSJ,GJZWLX,GJZWGHYT,GJZWMJ,JGSJ,BDCQZH,QXDM,DJJG,DBR,DJSJ,FJ,GJZWPMT,QSZT,WX_DCY,WX_DCSJ,WX_CLY,WX_CLSJ,WX_ZTY,WX_ZTSJ,WX_ZJY,WX_ZJSJ,WX_WYDM,DatabaseId,FLAGS,XGR,XGSJ FROM GJZWSYQ WHERE [FLAGS]<3";
        
		private const string SQL_INSERT_GJZWSYQ = "INSERT INTO [GJZWSYQ] (YSDM, BDCDYH, YWH, QLLX, DJLX, DJYY, ZL, TDHYSYQR, TDHYSYMJ, TDHYSYQSSJ, TDHYSYJSSJ, GJZWLX, GJZWGHYT, GJZWMJ, JGSJ, BDCQZH, QXDM, DJJG, DBR, DJSJ, FJ, GJZWPMT, QSZT, WX_DCY, WX_DCSJ, WX_CLY, WX_CLSJ, WX_ZTY, WX_ZTSJ, WX_ZJY, WX_ZJSJ, WX_WYDM, DatabaseId, FLAGS, XGR, XGSJ) VALUES ( @YSDM, @BDCDYH, @YWH, @QLLX, @DJLX, @DJYY, @ZL, @TDHYSYQR, @TDHYSYMJ, @TDHYSYQSSJ, @TDHYSYJSSJ, @GJZWLX, @GJZWGHYT, @GJZWMJ, @JGSJ, @BDCQZH, @QXDM, @DJJG, @DBR, @DJSJ, @FJ, @GJZWPMT, @QSZT, @WX_DCY, @WX_DCSJ, @WX_CLY, @WX_CLSJ, @WX_ZTY, @WX_ZTSJ, @WX_ZJY, @WX_ZJSJ, @WX_WYDM, @DatabaseId, @FLAGS, @XGR, @XGSJ);" + " SELECT last_insert_rowid();";
		
		private const string SQL_UPDATE_GJZWSYQ = "UPDATE [GJZWSYQ] SET YSDM = @YSDM, BDCDYH = @BDCDYH, YWH = @YWH, QLLX = @QLLX, DJLX = @DJLX, DJYY = @DJYY, ZL = @ZL, TDHYSYQR = @TDHYSYQR, TDHYSYMJ = @TDHYSYMJ, TDHYSYQSSJ = @TDHYSYQSSJ, TDHYSYJSSJ = @TDHYSYJSSJ, GJZWLX = @GJZWLX, GJZWGHYT = @GJZWGHYT, GJZWMJ = @GJZWMJ, JGSJ = @JGSJ, BDCQZH = @BDCQZH, QXDM = @QXDM, DJJG = @DJJG, DBR = @DBR, DJSJ = @DJSJ, FJ = @FJ, GJZWPMT = @GJZWPMT, QSZT = @QSZT, WX_DCY = @WX_DCY, WX_DCSJ = @WX_DCSJ, WX_CLY = @WX_CLY, WX_CLSJ = @WX_CLSJ, WX_ZTY = @WX_ZTY, WX_ZTSJ = @WX_ZTSJ, WX_ZJY = @WX_ZJY, WX_ZJSJ = @WX_ZJSJ, WX_WYDM = @WX_WYDM, DatabaseId = @DatabaseId, FLAGS = @FLAGS, XGR = @XGR, XGSJ = @XGSJ WHERE Id = @Id";
		
		private const string SQL_DELETE_GJZWSYQ = "DELETE FROM [GJZWSYQ] WHERE  Id = @Id ";
		
        private const string SQL_DELETE_FLAG_GJZWSYQ = "UPDATE [GJZWSYQ] Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE WHERE  Id = @Id ";
        #endregion
        ...
        ///土地/海域使用权人
		protected string tdhysyqr = default(string);
        ///土地/海域使用面积
		protected double? tdhysymj = default(double?);
        ///土地/海域使用起始时间
		protected System.DateTime? tdhysyqssj = default(System.DateTime?);
        ///土地/海域使用结束时间
		protected System.DateTime? tdhysyjssj = default(System.DateTime?);
        ///构（建）筑物类型[字典:构(建)筑物类型字典表-GJZWLXZD]
		protected string gjzwlx = default(string);
        ///构（建）筑物规划用途
		protected string gjzwghyt = default(string);
        ///构(建)筑物面积
		protected double? gjzwmj = default(double?);
        ///竣工时间
        ...
        ///构（建）筑物平面图
		protected byte[] gjzwpmt = default(byte[]);
        ...
        public string SimpleLabelString
        {
            get
            {
                return string.Format("{0} {1} ({2})","GJZWSYQ",this.id,this.ysdm);
            }
        }
        ...
        public string FullLabelString
        {
            get
            {
                return string.Format("{0} {1} ({2})","构（建）筑物所有权",this.id,this.ysdm);
            }
        }        
        #endregion
        ...
        ///土地/海域使用权人
        ///[Column(COL_TDHYSYQR, PARAM_TDHYSYQR )]
        public virtual string Tdhysyqr 
        {
            get { return this.tdhysyqr; }
			set	{ 
                  if(this.tdhysyqr != value)
                    {
                        this.OnPropertyChanging("Tdhysyqr"); 
                        this.tdhysyqr = value;                        
                        this.OnPropertyChanged("Tdhysyqr");
                    }   
                }
        }	
		
        ///土地/海域使用面积
        ///[Column(COL_TDHYSYMJ, PARAM_TDHYSYMJ )]
        public virtual double? Tdhysymj 
        {
            get { return this.tdhysymj; }
			set	{ 
                  if(this.tdhysymj != value)
                    {
                        this.OnPropertyChanging("Tdhysymj"); 
                        this.tdhysymj = value;                        
                        this.OnPropertyChanged("Tdhysymj");
                    }   
                }
        }	
		
        ///土地/海域使用起始时间
        ///[Column(COL_TDHYSYQSSJ, PARAM_TDHYSYQSSJ )]
        public virtual System.DateTime? Tdhysyqssj 
        {
            get { return this.tdhysyqssj; }
			set	{ 
                  if(this.tdhysyqssj != value)
                    {
                        this.OnPropertyChanging("Tdhysyqssj"); 
                        this.tdhysyqssj = value;                        
                        this.OnPropertyChanged("Tdhysyqssj");
                    }   
                }
        }	
		
        ///土地/海域使用结束时间
        ///[Column(COL_TDHYSYJSSJ, PARAM_TDHYSYJSSJ )]
        public virtual System.DateTime? Tdhysyjssj 
        {
            get { return this.tdhysyjssj; }
			set	{ 
                  if(this.tdhysyjssj != value)
                    {
                        this.OnPropertyChanging("Tdhysyjssj"); 
                        this.tdhysyjssj = value;                        
                        this.OnPropertyChanged("Tdhysyjssj");
                    }   
                }
        }	
		
        ///构（建）筑物类型
        ///[Column(COL_GJZWLX, PARAM_GJZWLX )]
        public virtual string Gjzwlx 
        {
            get { return this.gjzwlx; }
			set	{ 
                  if(this.gjzwlx != value)
                    {
                        this.OnPropertyChanging("Gjzwlx"); 
                        this.gjzwlx = value;                        
                        this.OnPropertyChanged("Gjzwlx");
                    }   
                }
        }	
		
        ///构（建）筑物规划用途
        ///[Column(COL_GJZWGHYT, PARAM_GJZWGHYT )]
        public virtual string Gjzwghyt 
        {
            get { return this.gjzwghyt; }
			set	{ 
                  if(this.gjzwghyt != value)
                    {
                        this.OnPropertyChanging("Gjzwghyt"); 
                        this.gjzwghyt = value;                        
                        this.OnPropertyChanged("Gjzwghyt");
                    }   
                }
        }	
		
        ///构(建)筑物面积
        ///[Column(COL_GJZWMJ, PARAM_GJZWMJ )]
        public virtual double? Gjzwmj 
        {
            get { return this.gjzwmj; }
			set	{ 
                  if(this.gjzwmj != value)
                    {
                        this.OnPropertyChanging("Gjzwmj"); 
                        this.gjzwmj = value;                        
                        this.OnPropertyChanged("Gjzwmj");
                    }   
                }
        }	
        ...
        ///构（建）筑物平面图
        ///[Column(COL_GJZWPMT, PARAM_GJZWPMT )]
        public virtual byte[] Gjzwpmt 
        {
            get { return this.gjzwpmt; }
			set	{ 
                  if(this.gjzwpmt != value)
                    {
                        this.OnPropertyChanging("Gjzwpmt"); 
                        this.gjzwpmt = value;                        
                        this.OnPropertyChanged("Gjzwpmt");
                    }   
                }
        }	
       ...
       ///图形类型
        ...
        public Gjzwsyq()
        {
            ...
            this.tdhysyqr="";
            this.tdhysymj=0.0;
            this.tdhysyqssj=DateTime.Now;
            this.tdhysyjssj=DateTime.Now;
            this.gjzwlx="";
            this.gjzwghyt="";
            this.gjzwmj=0.0;
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_INSERT_GJZWSYQ,dao.Connection))
            {
                this.databaseid=0;
                this.flags=1;
				...
				command.Parameters.AddWithValue(PARAM_TDHYSYQR, this.Tdhysyqr);
				command.Parameters.AddWithValue(PARAM_TDHYSYMJ, this.Tdhysymj);
				command.Parameters.AddWithValue(PARAM_TDHYSYQSSJ, this.Tdhysyqssj);
				command.Parameters.AddWithValue(PARAM_TDHYSYJSSJ, this.Tdhysyjssj);
				command.Parameters.AddWithValue(PARAM_GJZWLX, this.Gjzwlx);
				command.Parameters.AddWithValue(PARAM_GJZWGHYT, this.Gjzwghyt);
				command.Parameters.AddWithValue(PARAM_GJZWMJ, this.Gjzwmj);
				...
				command.Parameters.AddWithValue(PARAM_GJZWPMT, this.Gjzwpmt);
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_UPDATE_GJZWSYQ,dao.Connection))
            {
        ...
        public bool Delete(ISQLiteService dao)
        {
            if(this.databaseid==0)
            {
                using(SQLiteCommand command  = new SQLiteCommand(SQL_DELETE_GJZWSYQ,dao.Connection))
                {                   
    				command.Parameters.AddWithValue(PARAM_ID, this.ID);
                    return (command.ExecuteNonQuery() == 1);
                }
            ...
            {
                using(SQLiteCommand command  = new SQLiteCommand(SQL_DELETE_FLAG_GJZWSYQ,dao.Connection))
                {
        ...
        public void  LoadFromReader(SQLiteDataReader reader)
        {
			...
			if (!reader.IsDBNull(8)) tdhysyqr = reader.GetString(8);
			if (!reader.IsDBNull(9)) tdhysymj = reader.GetDouble(9);
			if (!reader.IsDBNull(10)) tdhysyqssj = reader.GetDateTime(10);
			if (!reader.IsDBNull(11)) tdhysyjssj = reader.GetDateTime(11);
			if (!reader.IsDBNull(12)) gjzwlx = reader.GetString(12);
			if (!reader.IsDBNull(13)) gjzwghyt = reader.GetString(13);
			if (!reader.IsDBNull(14)) gjzwmj = reader.GetDouble(14);
			if (!reader.IsDBNull(15)) jgsj = reader.GetDateTime(15);
			...
			if (!reader.IsDBNull(22)) gjzwpmt = SQLiteHelper.GetBytes(reader,"GJZWPMT");
        ...
        public IEntity Copy()
        {
            ...
            target.Zl=this.Zl;
            target.Tdhysyqr=this.Tdhysyqr;
            target.Tdhysymj=this.Tdhysymj;
            target.Tdhysyqssj=this.Tdhysyqssj;
            target.Tdhysyjssj=this.Tdhysyjssj;
            target.Gjzwlx=this.Gjzwlx;
            target.Gjzwghyt=this.Gjzwghyt;
            target.Gjzwmj=this.Gjzwmj;
