...
namespace VastGIS.RealEstate.Data.Entity
{
    ...
    public partial class Dxtdmtzzj:INotifyPropertyChanging, INotifyPropertyChanged
    {
        #region 表结构
	    ...
	    private const string SQL_INSERT_DXTDMTZZJ = "INSERT INTO DXTDMTZZJ (WBNR, TC, CASSDM, FH, FHDX, XZJD, YSDM, geometry) VALUES ( @WBNR, @TC, @CASSDM, @FH, @FHDX, @XZJD, @YSDM, GeomFromText(@geometry,@SRID));" + " SELECT last_insert_rowid();";
	
	    private const string SQL_UPDATE_DXTDMTZZJ = "UPDATE DXTDMTZZJ SET WBNR = @WBNR, TC = @TC, CASSDM = @CASSDM, FH = @FH, FHDX = @FHDX, XZJD = @XZJD, YSDM = @YSDM, geometry = GeomFromText(@geometry,@SRID) WHERE Id = @Id";
