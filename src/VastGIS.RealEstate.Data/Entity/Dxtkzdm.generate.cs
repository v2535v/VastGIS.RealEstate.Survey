...
namespace VastGIS.RealEstate.Data.Entity
{
    ...
    public partial class Dxtkzdm:INotifyPropertyChanging, INotifyPropertyChanged
    {
        #region 表结构
	    ...
	    private const string SQL_INSERT_DXTKZDM = "INSERT INTO DXTKZDM (TC, CASSDM, FSXX1, FSXX2, YSDM, geometry) VALUES ( @TC, @CASSDM, @FSXX1, @FSXX2, @YSDM, GeomFromText(@geometry,@SRID));" + " SELECT last_insert_rowid();";
	
	    private const string SQL_UPDATE_DXTKZDM = "UPDATE DXTKZDM SET TC = @TC, CASSDM = @CASSDM, FSXX1 = @FSXX1, FSXX2 = @FSXX2, YSDM = @YSDM, geometry = GeomFromText(@geometry,@SRID) WHERE Id = @Id";
