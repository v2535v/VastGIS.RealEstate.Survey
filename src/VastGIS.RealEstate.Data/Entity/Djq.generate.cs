...
namespace VastGIS.RealEstate.Data.Entity
{
    ...
    public partial class Djq:INotifyPropertyChanging, INotifyPropertyChanged,IBackEntity,IDatabaseEntity
    {
        #region 表结构
        ...
        private const string SQL_DELETE_FLAG_DJQ = "UPDATE DJQ Set Flags=3 WHERE  Id = @Id ";
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_INSERT_DJQ,connection))
            {	
        ...
        {
            using(SQLiteCommand command  = new SQLiteCommand(SQL_UPDATE_DJQ,connection))
            {							
		...
		public bool Delete(SQLiteConnection connection)
        {
            ...
            {
                using(SQLiteCommand command  = new SQLiteCommand(SQL_DELETE_DJQ,connection))
                {
            ...
            {
                using(SQLiteCommand command  = new SQLiteCommand(SQL_DELETE_FLAG_DJQ,connection))
                {
