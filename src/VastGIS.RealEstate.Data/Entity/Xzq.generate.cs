...
{
    public partial class Xzq : INotifyPropertyChanging, INotifyPropertyChanged,IDatabaseFeature,IYsdmEntity
    {		
		#region 表结构		
        public const string TABLE_NAME = "XZQ";	
        public const string LAYER_NAME = "行政区";	
		...
		#region SQL语句
		private const string SQL_QUERY_XZQ ="SELECT  Id,YSDM,XZQDM,XZQMC,XZQMJ,DatabaseId,FLAGS,XGR,XGSJ,AsText(geometry) as Wkt FROM XZQ WHERE [FLAGS]<3";
        ...
        private const string SQL_DELETE_FLAG_XZQ = "UPDATE [XZQ] Set Flags=3,XGR = @XGR, XGSJ = @XGSJ WHERE WHERE  Id = @Id ";
        #endregion
        ...
        public string FullLabelString
        {
            get
            {
                return string.Format("{0} {1} ({2})","行政区",this.id,this.ysdm);
            }
        }        
        #endregion
        ...
        ///行政区代码
        ///[Column(COL_XZQDM, PARAM_XZQDM )]
        public virtual string Xzqdm 
        {
        ...
        ///行政区名称
        ///[Column(COL_XZQMC, PARAM_XZQMC )]
        public virtual string Xzqmc 
        {
        ...
        ///行政区面积
        ///[Column(COL_XZQMJ, PARAM_XZQMJ )]
        public virtual double? Xzqmj 
        {
       ...
       public IGeometry Geometry
        ...
        public void  LoadFromReader(SQLiteDataReader reader)
        {
			...
			if (!reader.IsDBNull(2)) xzqdm = reader.GetString(2);
			if (!reader.IsDBNull(3)) xzqmc = reader.GetString(3);
			if (!reader.IsDBNull(4)) xzqmj = reader.GetDouble(4);
        ...
        public IEntity Copy()
        {
            ...
            target.Xzqdm=this.Xzqdm;
            target.Xzqmc=this.Xzqmc;
            target.Xzqmj=this.Xzqmj;
            target.DatabaseID=0;
            target.Flags=1;
