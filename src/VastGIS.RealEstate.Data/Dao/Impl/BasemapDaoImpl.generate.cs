...
namespace VastGIS.RealEstate.Data.Dao.Impl
{
    ...
    public partial class BasemapDaoImpl:SQLiteDao,BasemapDao
    {
        private BasemapDao _basemapDao;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLDWD" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLDWD" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLDWM" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLDWM" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLDWX" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLDWX" + " where "+filter;
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTDLDWZJ" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTDLDWZJ" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLSSD" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLSSD" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLSSM" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLSSM" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLSSX" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDLSSX" + " where "+filter;
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTDLSSZJ" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTDLSSZJ" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDMTZD" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDMTZD" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDMTZM" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDMTZM" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDMTZX" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTDMTZX" + " where "+filter;
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTDMTZZJ" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTDMTZZJ" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTJMDD" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTJMDD" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTJMDM" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTJMDM" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTJMDX" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTJMDX" + " where "+filter;
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTJMDZJ" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTJMDZJ" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTKZDD" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTKZDD" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTKZDM" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTKZDM" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTKZDX" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTKZDX" + " where "+filter;
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTKZDZJ" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTKZDZJ" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTQTD" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTQTD" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTQTM" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTQTM" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTQTX" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTQTX" + " where "+filter;
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTQTZJ" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTQTZJ" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTSXSSD" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTSXSSD" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTSXSSM" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTSXSSM" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTSXSSX" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTSXSSX" + " where "+filter;
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTSXSSZJ" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTSXSSZJ" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTZJD" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,XZJD,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTZJD" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTZJM" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTZJM" + " where "+filter;
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTZJX" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,TC,CASSDM,FH,FHDX,FSXX1,FSXX2,YSDM,AsText(geometry) as Wkt from DXTZJX" + " where "+filter;
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTZJZJ" + " where id="+id.ToString();
            ...
            {
                string sql="select Id,WBNR,TC,CASSDM,FH,FHDX,XZJD,YSDM,AsText(geometry) as Wkt from DXTZJZJ" + " where "+filter;
