...
namespace VastGIS.RealEstate.Data.Dao.Impl
{
    ...
    public partial class BasemapDaoImpl
    {
        string CREATE_BASEMAPD =
            "CREATE TABLE[DXT_LAYERNAME_D] ([Id] INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, [TC] NCHAR(100),[CASSDM] CHAR(20),[FH] NCHAR(30),[FHDX] FLOAT,[XZJD] FLOAT,[FSXX1] NCHAR(100),[FSXX2] NCHAR(100),[YSDM] CHAR(10),[DatabaseId] INTEGER,[FLAGS] SMALLINT);";

        string CREATE_BASEMAPM = "CREATE TABLE[DXT_LAYERNAME_M] ([Id] INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, [TC] NCHAR(100),[CASSDM] CHAR(20),[FSXX1] NCHAR(100),[FSXX2] NCHAR(100),[YSDM] CHAR(10),[DatabaseId] INTEGER,[FLAGS] SMALLINT);";

        string CREATE_BASEMAPX = "CREATE TABLE[DXT_LAYERNAME_X] ([Id] INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, [TC] NCHAR(100),[CASSDM] CHAR(20),[FH] NCHAR(30),[FHDX] FLOAT,[FSXX1] NCHAR(100),[FSXX2] NCHAR(100),[YSDM] CHAR(10),[DatabaseId] INTEGER,[FLAGS] SMALLINT);";

        string CREATE_BASEMAPZJ =
            "CREATE TABLE[DXT_LAYERNAME_ZJ] ([Id] INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, [WBNR] NCHAR(200),[TC] NCHAR(100),[CASSDM] CHAR(20),[FH] NCHAR(30),[FHDX] FLOAT,[XZJD] FLOAT,[YSDM] CHAR(10),[DatabaseId] INTEGER,[FLAGS] SMALLINT);";
