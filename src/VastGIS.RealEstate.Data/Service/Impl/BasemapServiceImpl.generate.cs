...
namespace VastGIS.RealEstate.Data.Service.Impl
{
    ...
    {	
        ...
        {
            return _basemapDao.GetEntity(tableName, id);
        }
        ...
        {
            return _basemapDao.GetEntities(tableName, queryFilter);
        }
        ...
        {
            return _basemapDao.FindFeatures(objectClass, x, y,torenlance);
        }
        public List<IReFeature> FindFeatures(List<VgObjectclass> objectClasses, double x, double y,double torenlance=1.0)
        {
            return _basemapDao.FindFeatures(objectClasses, x, y,torenlance);
        }
        #endregion
